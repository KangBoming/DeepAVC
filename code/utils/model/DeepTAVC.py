...
class DeepTAVC_Layer(nn.Module):
    def __init__(self, 
                 d_model, 
                 nhead, 
                 dropout=0.1, 
                 ...
                 batch_first=False, 
                 norm_first=False):
        super(DeepTAVC_Layer, self).__init__()
...
class DeepTAVC_Finetune(nn.Module):
    def __init__(self, 
                 d_model, 
                 n_heads, 
                 num_layers, 
        ...
        super(DeepTAVC_Finetune, self).__init__()
        ...
        self.smiles_layers = nn.ModuleList([
            nn.ModuleDict({
                ...
                'layer': DeepTAVC_Layer(d_model, n_heads, dropout=dropout,
        ...
        # Extract node feature using KPGT model
        self.kpgt_model = kpgt_model

        # forzen KPGT model parameters(optional)
